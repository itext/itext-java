...
public class PdfAPushbuttonfieldTest extends ExtendedITextTest {
    ...
    private static final String DESTINATION_FOLDER = "./target/test/com/itextpdf/pdfa/PdfAPushbuttonfieldTest/";
    ...
    public void pdfA1bButtonAppearanceTest() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new VeraPdfValidator().validate(outPath)); 
