...
public class PdfA1GraphicsTest extends ExtendedITextTest {
    ...
    public void colorCheckTest4() throws IOException, InterruptedException {
        String outPdf = DESTINATION_FOLDER + "pdfA1b_colorCheckTest4.pdf";
        String cmpPdf = CMP_FOLDER + "cmp_pdfA1b_colorCheckTest4.pdf";
    ...
    public void egsCheckTest2() throws IOException, InterruptedException {
        String outPdf = DESTINATION_FOLDER + "pdfA1b_egsCheckTest2.pdf";
        String cmpPdf = CMP_FOLDER + "cmp_pdfA1b_egsCheckTest2.pdf";
    ...
    public void transparencyCheckTest3() throws IOException, InterruptedException {
        String outPdf = DESTINATION_FOLDER + "pdfA1b_transparencyCheckTest3.pdf";
        String cmpPdf = CMP_FOLDER + "cmp_pdfA1b_transparencyCheckTest3.pdf";
    ...
    public void deviceGrayWithoutOutputIntentTest() {
        PdfADocument doc = new PdfADocument(new PdfWriter(new ByteArrayOutputStream()), PdfAConformance.PDF_A_1B, null);
        doc.addNewPage();
        PdfCanvas canvas = new PdfCanvas(doc.getLastPage());
        ...
        Exception e = Assertions.assertThrows(PdfAConformanceException.class, () -> doc.close());
        Assertions.assertEquals(
            PdfaExceptionMessageConstant.IF_DEVICE_RGB_CMYK_GRAY_USED_IN_FILE_THAT_FILE_SHALL_CONTAIN_PDFA_OUTPUTINTENT,
            e.getMessage());
    }
