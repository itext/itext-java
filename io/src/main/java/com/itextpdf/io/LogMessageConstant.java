...
public final class LogMessageConstant {
    ...
    public static final String FEATURE_IS_DEPRECATED = "{0} is deprecated for the {1} and higher versions. It is highly recommended not to use it.";
    ...
    public static final String NEED_APPEARANCES_DEPRECATED_IN_PDF20 = "NeedAppearances has been deprecated in PDF 2.0. Appearance streams are required in PDF 2.0.";
    ...
    public static final String XFA_DEPRECATED_IN_PDF20 = "XFA is deprecated in PDF 2.0. The XFA form will not be written to the document";
