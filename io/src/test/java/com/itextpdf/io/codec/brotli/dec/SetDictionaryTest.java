 ...
 */
@Tag("UnitTest")
@Disabled("This test fails since Dictionary data is set automatically during " +
        "com.itextpdf.io.codec.brotli.dec.DictionaryData class load. Also RFC_DICTIONARY env var is not set.")
public class SetDictionaryTest extends ExtendedITextTest {
