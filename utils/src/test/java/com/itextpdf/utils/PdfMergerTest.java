...
public class PdfMergerTest {
    ...
    @Test
    public void mergeDocumentTest01() throws IOException, PdfException, InterruptedException, DocumentException {
    ...
    @Test
     public void mergeDocumentTest02() throws IOException, PdfException, InterruptedException, DocumentException {
    ...
    @Test
    public void mergeDocumentTest03() throws IOException, PdfException, InterruptedException, DocumentException {
    ...
    @Test
    public void mergeDocumentTest04() throws IOException, PdfException, InterruptedException, DocumentException {
        String filename = sourceFolder + "pdf_open_parameters.pdf";
        String filename1 = sourceFolder + "iphone_user_guide.pdf";
