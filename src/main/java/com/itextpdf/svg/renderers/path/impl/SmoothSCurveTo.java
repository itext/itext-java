 ...
 * */
public class SmoothSCurveTo extends AbstractPathShape {
 ...
 * */
    ...
    public void setCoordinates(String[] coordinates) {
        ...
        map.put( "x2", coordinates.length > 0 && !coordinates[0].isEmpty()? coordinates[0] : "0" );
        map.put( "y2", coordinates.length > 1 && !coordinates[1].isEmpty()? coordinates[1] : "0" );
