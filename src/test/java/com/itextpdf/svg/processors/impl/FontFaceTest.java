...
public class FontFaceTest extends SvgIntegrationTest {
    ...
    public static final String sourceFolder = "./src/test/resources/com/itextpdf/svg/processors/impl/FontFaceTest/";
    public static final String destinationFolder = "./target/test/com/itextpdf/svg/processors/impl/FontFaceTest/";
    ...
    @Test
   // TODO("DEVSIX-1759") please check if the issue is still relevent
