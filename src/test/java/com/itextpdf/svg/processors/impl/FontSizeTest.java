...
public class FontSizeTest extends SvgIntegrationTest {
    ...
    public static final String sourceFolder = "./src/test/resources/com/itextpdf/svg/processors/impl/FontSizeTest/";
    public static final String destinationFolder = "./target/test/com/itextpdf/svg/processors/impl/FontSizeTest/";
