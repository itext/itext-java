...
public class FontAttributesTest extends SvgIntegrationTest {
    private static final String SOURCE_FOLDER = "./src/test/resources/com/itextpdf/svg/css/FontAttributesTest/";
    private static final String DESTINATION_FOLDER = TestUtil.getOutputPath() + "/svg/css/FontAttributesTest/";
    private static final String FONTS_FOLDER = "./src/test/resources/com/itextpdf/svg/fonts/";
