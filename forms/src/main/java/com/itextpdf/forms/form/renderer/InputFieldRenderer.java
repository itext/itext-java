...
public class InputFieldRenderer extends AbstractOneLineTextFieldRenderer {
    ...
    private static final LazyLogger LOGGER = new LazyLogger(InputFieldRenderer.class);
    ...
    protected void adjustFieldLayout(LayoutContext layoutContext) {
        ...
        if (flatLines.isEmpty() || font == null) {
            LOGGER.error(() -> MessageFormatUtil.format(
                    FormsLogMessageConstants.ERROR_WHILE_LAYOUT_OF_FORM_FIELD_WITH_TYPE, "text input"));
