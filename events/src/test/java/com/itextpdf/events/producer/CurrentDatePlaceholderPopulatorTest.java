...
public class CurrentDatePlaceholderPopulatorTest extends ExtendedITextTest {
    ...
    public void nullTest() {
        ...
        junitExpectedException.expectMessage(MessageFormatUtil.format(EventsExceptionMessageConstant.INVALID_USAGE_FORMAT_REQUIRED, "currentDate"));
    ...
    public void plainTextEndlessQuotationErrorTest() {
        junitExpectedException.expect(IllegalArgumentException.class);
        junitExpectedException.expectMessage(EventsExceptionMessageConstant.PATTERN_CONTAINS_OPEN_QUOTATION);
    ...
    public void unexpectedLetterComponentTest() {
        junitExpectedException.expect(IllegalArgumentException.class);
        junitExpectedException.expectMessage(MessageFormatUtil.format(EventsExceptionMessageConstant.PATTERN_CONTAINS_UNEXPECTED_COMPONENT, "t"));
    ...
    public void unexpectedLongComponentTest() {
        junitExpectedException.expect(IllegalArgumentException.class);
        junitExpectedException.expectMessage(MessageFormatUtil.format(EventsExceptionMessageConstant.PATTERN_CONTAINS_UNEXPECTED_COMPONENT, "MMMMM"));
    ...
    public void unexpectedShortComponentTest() {
        junitExpectedException.expect(IllegalArgumentException.class);
        junitExpectedException.expectMessage(MessageFormatUtil.format(EventsExceptionMessageConstant.PATTERN_CONTAINS_UNEXPECTED_COMPONENT, "y"));
