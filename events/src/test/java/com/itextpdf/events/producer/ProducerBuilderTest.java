...
public class ProducerBuilderTest extends ExtendedITextTest {
    ...
    public void emptyEventsProducerLineTest() {
        ...
        junitExpectedException.expectMessage(EventsExceptionMessageConstant.NO_EVENTS_WERE_REGISTERED_FOR_THE_DOCUMENT);
    ...
    @LogMessages(messages = {
            @LogMessage(messageTemplate = EventsLogMessageConstant.UNKNOWN_PLACEHOLDER_WAS_IGNORED, count = 3, logLevel = LogLevelConstants.INFO)
    })
