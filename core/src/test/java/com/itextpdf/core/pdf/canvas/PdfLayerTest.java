...
public class PdfLayerTest extends ExtendedITextTest{
    ...
    static final public String sourceFolder = "./src/test/resources/com/itextpdf/core/pdf/PdfLayerTest/";
    static final public String destinationFolder = "./target/test/com/itextpdf/core/PdfLayerTest/";
    ...
    public void testInStamperMode2() throws IOException, InterruptedException {
        ...
        canvas.beginLayer(newLayer).beginText().setFontAndSize(PdfFontFactory.createStandardFont(FontConstants.HELVETICA), 18).
