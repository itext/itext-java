...
import com.itextpdf.core.color.DeviceN;
import com.itextpdf.core.color.DeviceRgb;
import com.itextpdf.core.color.IccBased;
...
public class PdfCanvasTest extends ExtendedITextTest {
    ...
    static final public String sourceFolder = "./src/test/resources/com/itextpdf/core/pdf/PdfCanvasTest/";
    static final public String destinationFolder = "./target/test/com/itextpdf/core/PdfCanvasTest/";
    ...
    public void createSimpleCanvasWithText() throws IOException {
        ...
        canvas
                ...
                .beginText()
                .moveText(36, 750)
                .setFontAndSize(PdfFont.createStandardFont(FontConstants.HELVETICA), 16)
        ...
        canvas
                ...
                .beginText()
                .moveText(36, 700)
                .setFontAndSize(PdfFont.createStandardFont(FontConstants.HELVETICA_BOLDOBLIQUE), 16)
        ...
        canvas
                ...
                .beginText()
                .moveText(36, 650)
                .setFontAndSize(PdfFont.createStandardFont(FontConstants.COURIER), 16)
        ...
        canvas
                ...
                .beginText()
                .moveText(36, 600)
                .setFontAndSize(PdfFont.createStandardFont(FontConstants.TIMES_ITALIC), 16)
        ...
        canvas
                ...
                .beginText()
                .moveText(36, 550)
                .setFontAndSize(PdfFont.createStandardFont(FontConstants.SYMBOL), 16)
        ...
        canvas
                ...
                .beginText()
                .moveText(36, 500)
                .setFontAndSize(PdfFont.createStandardFont(FontConstants.ZAPFDINGBATS), 16)
    ...
    public void create1000PagesDocument() throws IOException {
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            canvas
                    ...
                    .beginText()
                    .moveText(36, 700)
                    .setFontAndSize(PdfFont.createStandardFont(FontConstants.HELVETICA), 72)
    ...
    public void copyPagesTest1() throws IOException,  InterruptedException {
        ...
        canvas.fill();
        canvas.beginText();
        canvas.setFontAndSize(PdfFont.createStandardFont(FontConstants.COURIER), 12);
