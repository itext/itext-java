...
public class PdfFunction<T extends PdfObject> extends PdfObjectWrapper {
    ...
    public PdfFunction(PdfObject pdfObject, PdfDocument pdfDocument) throws PdfException {
    ...
    static public class Type0 extends PdfFunction<PdfStream> {
        ...
        public Type0(PdfDocument document, PdfArray domain, PdfArray range, PdfArray size, PdfNumber bitsPerSample, byte[] samples) throws PdfException {
            this(document, domain, range, size, bitsPerSample, null, null, null, samples);
        }

        public Type0(PdfDocument document, PdfArray domain, PdfArray range, PdfArray size, PdfNumber bitsPerSample, PdfNumber order, PdfArray encode, PdfArray decode, byte[] samples) throws PdfException {
            this(makeType0(document, domain, range, size, bitsPerSample, order, encode, decode, samples), document);
        }

        private static PdfStream makeType0(PdfDocument document, PdfArray domain, PdfArray range, PdfArray size, PdfNumber bitsPerSample, PdfNumber order, PdfArray encode, PdfArray decode, byte[] samples) throws PdfException {
    ...
    static public class Type2 extends PdfFunction<PdfDictionary> {
        ...
        public Type2(PdfDictionary pdfObject, PdfDocument pdfDocument) throws PdfException {
            super(pdfObject, pdfDocument);
        }

        public Type2(PdfDocument document, PdfArray domain, PdfArray range, PdfNumber n) throws PdfException {
            this(document, domain, range, null, null, n);
        }

        public Type2(PdfDocument document, PdfArray domain, PdfArray range, PdfArray c0, PdfArray c1, PdfNumber n) throws PdfException {
            this(makeType2(domain, range, c0, c1, n), document);
        }

        private static PdfDictionary makeType2(PdfArray domain, PdfArray range, PdfArray c0, PdfArray c1, PdfNumber n) throws PdfException {
    ...
    static public class Type3 extends PdfFunction<PdfDictionary> {
        ...
        public Type3(PdfDictionary pdfObject, PdfDocument pdfDocument) throws PdfException {
            super(pdfObject, pdfDocument);
        }

        public Type3(PdfDocument document, PdfArray domain, PdfArray range, PdfArray functions, PdfArray bounds, PdfArray encode) throws PdfException {
            this(makeType3(domain, range, functions, bounds, encode), document);
        }

        public Type3(PdfDocument document, PdfArray domain, PdfArray range, List<PdfFunction> functions, PdfArray bounds, PdfArray encode) throws PdfException {
            this(document, domain, range, getFunctionsArray(functions), bounds, encode);
        }

        private static PdfDictionary makeType3(PdfArray domain, PdfArray range, PdfArray functions, PdfArray bounds, PdfArray encode) throws PdfException {
            PdfDictionary dictionary = new PdfDictionary();
    ...
    static public class Type4 extends PdfFunction<PdfStream> {
        ...
        public Type4(PdfStream pdfObject, PdfDocument pdfDocument) throws PdfException {
            super(pdfObject, pdfDocument);
        }

        public Type4(PdfDocument document, PdfArray domain, PdfArray range, byte[] ps) throws PdfException {
            this(makeType4(document, domain, range, ps), document);
        }

        private static PdfStream makeType4(PdfDocument document, PdfArray domain, PdfArray range, byte[] ps) throws PdfException {
    ...
    public static PdfFunction makeFunction(PdfDictionary pdfObject, PdfDocument document) throws PdfException {
