...
public final class ImageFactory {
    ...
    public static Image getImage(byte[] bytes, boolean recoverImage) throws PdfException {
        return getImageInstance(bytes, recoverImage);
    }

    public static Image getImage(byte[] bytes) throws PdfException {
        return getImage(bytes, false);
    }

    public static Image getImage(URL url, boolean recoverImage) throws PdfException {
        return getImageInstance(url, recoverImage);
    }

    public static Image getImage(URL url) throws PdfException {
        return getImage(url, false);
    }

    public static Image getImage(String filename, boolean recoverImage) throws PdfException, MalformedURLException {
        return getImage(Utilities.toURL(filename), recoverImage);
    }

    public static Image getImage(String filename) throws PdfException, MalformedURLException {
    ...
    public static Image getImage(final int width, final int height, final boolean reverseBits,
                                    ...
                                    final int[] transparency) throws PdfException {
    ...
    public static Image getImage(final int width, final int height, final int components,
                                    final int bpc, final byte[] data, final int[] transparency) throws PdfException {
    ...
    public static Image getBmpImage(URL url, boolean noHeader, int size) throws PdfException {
    ...
    public static Image getGifImage(URL url, int frame) throws PdfException {
        byte[] imageType = readImageType(url);
    ...
    public static Image getGifImage(byte[] bytes, int frame) throws PdfException {
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, gif)) {
    ...
    public static Image getJbig2Image(URL url, int page) throws PdfException {
        if (page < 1)
    ...
    public static Image getJbig2Image(byte[] bytes, int page) throws PdfException {
        if (page < 1)
            throw new IllegalArgumentException("The page number must be greater than 0");
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, jbig2)) {
    ...
    public static Image getJpegImage(URL url) throws PdfException {
        byte[] imageType = readImageType(url);
    ...
    public static Image getJpegImage(byte[] bytes) throws PdfException {
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, jpeg)) {
    ...
    public static Image getJpeg2000Image(URL url) throws PdfException {
        byte[] imageType = readImageType(url);
    ...
    public static Image getJpeg2000Image(byte[] bytes) throws PdfException {
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, jpeg2000_1) || imageTypeIs(imageType, jpeg2000_2)) {
    ...
    public static Image getPngImage(URL url) throws PdfException {
        byte[] imageType = readImageType(url);
    ...
    public static Image getPngImage(byte[] bytes) throws PdfException {
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, png)) {
    ...
    public static Image getTiffImage(URL url, boolean recoverFromImageError, int page, boolean direct) throws PdfException {
        byte[] imageType = readImageType(url);
    ...
    public static Image getTiffImage(byte[] bytes, boolean recoverFromImageError, int page, boolean direct) throws PdfException {
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, tiff_1) || imageTypeIs(imageType, tiff_2)) {
    ...
    public static Image getWmfImage(URL url) throws PdfException {
        byte[] imageType = readImageType(url);
    ...
    public static Image getWmfImage(byte[] bytes) throws PdfException {
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, wmf)) {
    ...
    public static Image getRawImage(byte[] bytes) throws PdfException {
        return new RawImage(bytes, Image.RAW);
    }

    private static Image getImageInstance(URL source, boolean recoverImage) throws PdfException {
    ...
    private static Image getImageInstance(byte[] bytes, boolean recoverImage) throws PdfException {
        byte[] imageType = readImageType(bytes);
        if (imageTypeIs(imageType, gif)) {
    ...
    private static <T> byte[] readImageType(T source) throws PdfException {
        InputStream is = null;
        try {
