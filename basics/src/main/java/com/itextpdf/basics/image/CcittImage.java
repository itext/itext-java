...
public class CcittImage extends Image {
    ...
    public CcittImage(int width, int height, boolean reverseBits, int typeCCITT, int parameters, byte[] data) throws PdfException {
        super();
