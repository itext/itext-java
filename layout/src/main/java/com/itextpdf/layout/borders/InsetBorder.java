...
public class InsetBorder extends Border3D {
    ...
    /**
     * Creates an InsetBorder instance with the specified width and the {@link DeviceRgb rgb color}.
     *
     * @param width width of the border
    ...
    /**
     * Creates an InsetBorder instance with the specified width and the {@link DeviceCmyk cmyk color}.
     *
     * @param width width of the border
    ...
    /**
     * Creates an InsetBorder instance with the specified width and the {@link DeviceGray gray color}.
     *
     * @param width width of the border
