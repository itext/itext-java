...
import com.itextpdf.signatures.validation.lotl.SingleXmlFileLotlService.CountrySpecificLotlWithCerts;
...
@Tag("IntegrationTest")
public class SingleXmlFileLotlServiceTest extends ExtendedITextTest {
    private final String XML = "./src/test/resources/com/itextpdf/signatures/validation/lotl/CustomValidatorTest/";
    private static final List<CountrySpecificLotl> countrySpecificLotls = Arrays.asList(
            new CountrySpecificLotl("AR", "https://pki.jgm.gov.ar/TSL/tsl-AR.xml", "application/vnd.etsi.tsl+xml"),
            new CountrySpecificLotl("DO", "https://applin.indotel.gob.do/tsl/tsl.xml", "application/vnd.etsi.tsl+xml"),
            ...
            // "application/vnd.etsi.tsl+xml"),
            //new CountrySpecificLotl("MX", "https://www.cloudb.sat.gob.mx/TSP_MX.xml", "application/vnd.etsi.tsl+xml"),
            new CountrySpecificLotl("UK", "https://tl.ico.org.uk/uktrustedlist/UKTL.xml",
                    "application/vnd.etsi.tsl+xml"),
            new CountrySpecificLotl("GE", "https://dga.gov.ge/files/GeorgianTSL.xml", "application/vnd.etsi.tsl+xml"),
            //new CountrySpecificLotl("RS", "https://www.mit.gov.rs/TrustedList/TSL-RS.xml", "application/vnd.etsi
            // .tsl+xml"),
           ...
           //         "application/vnd.etsi.tsl+xml"),
            new CountrySpecificLotl("CL",
                    ...
                    "application/vnd.etsi.tsl+xml"),
            new CountrySpecificLotl("AE", "https://uri.trustservices.gov.ae/uae-trusted-list/UAE-TL.xml",
                    "application/vnd.etsi.tsl+xml"),
            new CountrySpecificLotl("UR",
                    "https://www.gub.uy/unidad-certificacion-electronica/sites/unidad-certificacion-electronica/files"
                            + "/2022-11/tsl_uy.xml",
                    "application/vnd.etsi.tsl+xml"),
            new CountrySpecificLotl("PE", "https://iofe.indecopi.gob.pe/TSL/tsl-pe.xml", "application/vnd.etsi.tsl+xml")
    );

    private static final List<String> certificates = Arrays.asList(
            //Argentina
            "-----BEGIN CERTIFICATE-----\n" +
            ...
            //Dominican
            "-----BEGIN CERTIFICATE-----\n" +
                    "MIIHvTCCBaWgAwIBAgIUD/O5mNGpkAgO"
                    +
                    "\n"
                    +
                    "-----END CERTIFICATE-----",
            //Switzerland
            "-----BEGIN CERTIFICATE-----\n" +
            ...
            //UAE
            "-----BEGIN CERTIFICATE-----\n" +
                    "MIIErDCCAxSgAwIBAgIIe10B2MO/ZxIwDQYJKoZIhvcNAQELBQAwbDFHMEUGA1UECgw"
                    +
                    "\n"
                    +
                    "-----END CERTIFICATE-----",
            //Uruguay
            "-----BEGIN CERTIFICATE-----\n" +
            ...
            //Peru
            "-----BEGIN CERTIFICATE-----\n" +
                    "\n"
                    +
                    "-----END CERTIFICATE-----"
    );
    ...
    public void testDifferentCountries(String countryCode, String tslLocation, CountrySpecificLotl countrySpecificLotl,
            String certificate) {
        System.out.println("Testing country: " + countryCode + " with TSL: " + tslLocation);
        CountrySpecificLotlWithCerts lotlWithCerts = new CountrySpecificLotlWithCerts(countrySpecificLotl,
                 certificates);

        LotlFetchingProperties props = new LotlFetchingProperties(new RemoveOnFailingCountryData());
        props.setCountryNames(countrySpecificLotl.getSchemeTerritory());
        LotlService lotlService = new SingleXmlFileLotlService(props, lotlWithCerts);
       lotlService.withCustomResourceRetriever(new FromDiskResourceRetriever(XML));
        ...
        Assertions.assertTrue(report.getFailures().size() == 0);
    }




    private static Stream<Arguments> provideCountryData() {
        return Stream.of(
                Arguments.of(countrySpecificLotls.get(0).getSchemeTerritory(),
                        countrySpecificLotls.get(0).getTslLocation(),
                        countrySpecificLotls.get(0),
                        certificates.get(0)),
                Arguments.of(countrySpecificLotls.get(1).getSchemeTerritory(),
                        countrySpecificLotls.get(1).getTslLocation(),
                        countrySpecificLotls.get(1),
                        certificates.get(1)),
                Arguments.of(countrySpecificLotls.get(2).getSchemeTerritory(),
                        countrySpecificLotls.get(2).getTslLocation(),
                        countrySpecificLotls.get(2),
                        certificates.get(2)),
                Arguments.of(countrySpecificLotls.get(3).getSchemeTerritory(),
                        countrySpecificLotls.get(3).getTslLocation(),
                        countrySpecificLotls.get(3),
                        certificates.get(3)),
                Arguments.of(countrySpecificLotls.get(4).getSchemeTerritory(),
                        countrySpecificLotls.get(4).getTslLocation(),
                        countrySpecificLotls.get(4),
                        certificates.get(4)),
                Arguments.of(countrySpecificLotls.get(5).getSchemeTerritory(),
                        countrySpecificLotls.get(5).getTslLocation(),
                        countrySpecificLotls.get(5),
                        certificates.get(5)),
                Arguments.of(countrySpecificLotls.get(6).getSchemeTerritory(),
                        countrySpecificLotls.get(6).getTslLocation(),
                        countrySpecificLotls.get(6),
                        certificates.get(6)),
                Arguments.of(countrySpecificLotls.get(7).getSchemeTerritory(),
                        countrySpecificLotls.get(7).getTslLocation(),
                        countrySpecificLotls.get(7),
                        certificates.get(7)),
                Arguments.of(countrySpecificLotls.get(8).getSchemeTerritory(),
                        countrySpecificLotls.get(8).getTslLocation(),
                        countrySpecificLotls.get(8),
                        certificates.get(8))
          //      ,Arguments.of(countrySpecificLotls.get(9).getSchemeTerritory(),
          //              countrySpecificLotls.get(9).getTslLocation(),
          //              countrySpecificLotls.get(9),
          //              certificates.get(9))
        );
    }
}