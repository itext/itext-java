...
public class CRLValidatorTest extends ExtendedITextTest {
    ...
    /**
     * This field is used to configure the file to use for the missing certificates.
     */
    private String missingCertsFileName;
    /**
     * This field is used to configure the CRL response to return.
     */
    ...
    public void nextUpdateBeforeValidationTest() throws Exception {
        ...
        Assert.assertEquals(  MessageFormatUtil.format(CRLValidator.UPDATE_DATE_BEFORE_CHECKDATE,
    ...
    public void crlEncodingErrorTest() throws Exception {
        ...
        new CRLValidator().setIssuingCertificateRetriever(mockCertificateRetriever)
                .validate(report, certificateUnderTest, crl, TimeTestUtil.TEST_DATE_TIME);
        Assert.assertEquals(ValidationReport.ValidationResult.INDETERMINATE, report.getValidationResult());
    }
    ...
    private static class MockChainValidator extends CertificateChainValidator {
        ...
        public ValidationReport validate(ValidationReport result,
                                                      X509Certificate certificate, Date verificationDate,
