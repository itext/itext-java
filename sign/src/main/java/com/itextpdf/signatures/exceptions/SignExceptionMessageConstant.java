...
public final class SignExceptionMessageConstant {
    ...
    public static final String AUTHENTICATED_ATTRIBUTE_IS_MISSING_THE_DIGEST =
    ...
    public static final String AVAILABLE_SPACE_IS_NOT_ENOUGH_FOR_SIGNATURE = "Available space is not enough for " +
            "signature.";
    public static final String TOKEN_ESTIMATION_SIZE_IS_NOT_LARGE_ENOUGH =
            "Timestamp token estimation size is not " + "large enough to accommodate the entire timestamp token. " +
                    "Timestamp token estimation size is: {0} bytes, " + "however real timestamp token size is: {1} " +
                    "bytes.";
    public static final String CANNOT_DECODE_PKCS7_SIGNED_DATA_OBJECT = "Cannot decode PKCS#7 SignedData object.";
    public static final String CANNOT_FIND_SIGNING_CERTIFICATE_WITH_THIS_SERIAL =
    ...
    public static final String CANNOT_BE_VERIFIED_CERTIFICATE_CHAIN = "Cannot be verified against the KeyStore or the" +
            " " + "certificate chain.";
    public static final String CERTIFICATION_SIGNATURE_CREATION_FAILED_DOC_SHALL_NOT_CONTAIN_SIGS =
            "Certification " + "signature creation failed. Document shall not contain any certification or approval " +
                    "signatures before " + "signing with certification signature.";
    public static final String CERTIFICATE_TEMPLATE_FOR_EXCEPTION_MESSAGE = "Certificate {0} failed: {1}";
    public static final String DEFAULT_CLIENTS_CANNOT_BE_CREATED =
            "Default implementation of OCSP and CRL clients " + "cannot be created, because signing certificate " +
                    "doesn't contain revocation data sources. " + "Please try to explicitly add OCSP or CRL client.";
    ...
    public static final String DIGEST_ALGORITHMS_ARE_NOT_SAME = "Digest algorithm used in the provided " +
            "IExternalSignature shall be the same as digest algorithm in the provided CMSContainer. " + "Digest " +
            "algorithm in CMS container: \"{0}\". Digest algorithm in IExternalSignature: \"{1}\"";
    ...
    public static final String NOT_A_VALID_PKCS7_OBJECT_NOT_SIGNED_DATA =
    ...
    public static final String NOT_POSSIBLE_TO_EMBED_MAC_TO_SIGNATURE = "It was not possible to embed MAC token into " +
            "signature. Most likely signature container is empty.";
    public static final String PATH_IS_NOT_DIRECTORY = "Provided path: {0} is not a directory. " + "Please provide a " +
            "directory path to store temporary pdf files which are required for signing.";
    public static final String PROVIDED_TSA_CLIENT_IS_NULL = "Provided TSA client is null. TSA client is required for" +
            " timestamp signing.";
    ...
    public static final String COULD_NOT_DETERMINE_SIGNATURE_MECHANISM_OID = "Could not determine OID for signature " +
            "algorithm {0} with digest {1}.";
    public static final String VERIFICATION_ALREADY_OUTPUT = "Verification already output.";

    public static final String ALGO_REQUIRES_SPECIFIC_HASH = "{0} requires the document to be digested using {1}, not" +
            " {2}";

    public static final String ONLY_MGF1_SUPPORTED_IN_RSASSA_PSS = "Only MGF1 is supported in RSASSA-PSS";
    public static final String RSASSA_PSS_DIGESTMISSMATCH =
    ...
    public static final String CMS_SIGNERINFO_READONLY = "Updating the signed attributes of this SignerInfo instance " +
    ...
    public static final String CMS_MISSING_CERTIFICATES = "The certificate set must at least contains the signer " +
            "certificate";
    ...
    public static final String EITHER_USE_SCHEMA_NAME_OR_IGNORE_SCHEMA_NAME = "You cannot use both 'addSchemaName' " +
    ...
    public static final String QUALIFIED_VALIDATOR_ALREADY_USED =
            "QualifiedValidator instance has to be created from scratch per each validated document. " +
                    "Alternatively, one can obtain previous validation results by using " +
                    "QualifiedValidator#obtainAllSignaturesValidationResults() before running the validation " +
