...
public interface INameConstraints extends IASN1Encodable {
    /**
     * Calls actual {@code getPermittedSubtrees} method for the wrapped NameConstraints object.
     *
     * @return {@link IGeneralSubtree} array of wrapped GeneralSubtree objects.
     */
    IGeneralSubtree[] getPermittedSubtrees();

    /**
     * Calls actual {@code getExcludedSubtrees} method for the wrapped NameConstraints object.
     *
     * @return {@link IGeneralSubtree} array of wrapped GeneralSubtree objects.
     */
