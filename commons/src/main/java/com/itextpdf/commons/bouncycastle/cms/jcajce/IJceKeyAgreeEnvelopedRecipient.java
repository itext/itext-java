...
public interface IJceKeyAgreeEnvelopedRecipient extends IRecipient {
    /**
     * Calls actual {@code setProvider} method for the wrapped JceKeyAgreeEnvelopedRecipient object.
     *
     * @param provider provider name
     *
     * @return {@link IJceKeyAgreeEnvelopedRecipient} this wrapper object.
     */
    IJceKeyAgreeEnvelopedRecipient setProvider(String provider);
}
