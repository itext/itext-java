...
public class RectangleTest extends ExtendedITextTest{
    ...
    public void envelopTest01(){
        ...
        Rectangle one= new Rectangle(0,0,10,10);
        Rectangle two = new Rectangle(5,5,5,5);
        Boolean result = one.envelops(two);
        Assert.assertTrue(result);
    }
    ...
    @Test
    public void getIntersectionRectangleTest01(){
    ...
    @Test
    public void getIntersectionRectangleTest02(){
    ...
    @Test
    public void getIntersectionRectangleTest03(){
    ...
    @Test
    public void getIntersectionRectangleTest04(){
