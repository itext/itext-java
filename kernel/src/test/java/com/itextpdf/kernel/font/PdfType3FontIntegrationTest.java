...
@Tag("IntegrationTest")
public class PdfType3FontIntegrationTest extends ExtendedITextTest {
    ...
    @Test
    public void flushMultCIDToSingleUnicodeDefaultMappingTest() throws IOException, InterruptedException {
    ...
    @Test
    public void flushMultCIDToSingleUnicodeToUnicodeCMapTest() throws IOException, InterruptedException {
