...
public class IndicTextExtractionTest extends ExtendedITextTest {
    ...
    @Test
    @Ignore("Seems to be a problem with decode. We need to support /ToUnicode mapping to several characters (ligatures case). " +
            "Also note that /ActualText is parsed. For pure content stream parsing set useActualText to false")
    ...
    public void test02() throws IOException {
        ...
        Assert.assertEquals(text, PdfTextExtractor.getTextFromPage(pdfDocument.getPage(1), new LocationTextExtractionStrategy().setUseActualText(true)));
    }
