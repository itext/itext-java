 ...
 */
public class StandardOutputEventCounter extends EventCounter {
    ...
    public StandardOutputEventCounter(String name) {
        this.name = name;
    }

    public StandardOutputEventCounter() {
        this("iText");
    }

    public StandardOutputEventCounter(Class<?> cls) {
        this(cls.getName());
    }
