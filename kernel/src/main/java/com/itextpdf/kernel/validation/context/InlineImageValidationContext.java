...
public class InlineImageValidationContext implements IValidationContext {
    ...
    /**
     * Instantiates a new {@link InlineImageValidationContext} based on image and resources.
     *
     * @param image the image
     * @param resources the resources which are used to extract color space of the image
     */
