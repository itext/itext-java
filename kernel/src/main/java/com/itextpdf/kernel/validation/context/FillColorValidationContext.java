...
public class FillColorValidationContext extends AbstractColorValidationContext {
    /**
     * Instantiates a new {@link FillColorValidationContext} based on graphics state, resources and content stream.
     *
     * @param canvasGraphicsState the canvas graphics state
     * @param resources the resources
     * @param stream the content stream
     */
    public FillColorValidationContext(CanvasGraphicsState canvasGraphicsState, PdfResources resources,
            PdfStream stream) {
