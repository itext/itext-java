 ...
 */
public class ExtendedGStateValidationContext implements IValidationContext,
    ...
    /**
     * Instantiates a new {@link ExtendedGStateValidationContext} based on graphics state and content stream.
     *
     * @param graphicsState the graphics state
