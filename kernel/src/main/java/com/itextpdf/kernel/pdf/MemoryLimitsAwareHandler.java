 ...
 *
 * <p>The handler is primarily used during decoding (decompression) of PDF streams, but also guards against other
 * potentially unbounded structures during reading, e.g. cross-reference (xref) table growth and per-page XObject usage.
 *
...
public class MemoryLimitsAwareHandler {
    ...
    /**
     * Creates a {@link MemoryLimitsAwareHandler} to handle decompression of PDF streams and other memory-related limits
     * during reading.
     */
