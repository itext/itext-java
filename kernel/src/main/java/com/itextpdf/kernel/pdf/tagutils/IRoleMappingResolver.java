...
public interface IRoleMappingResolver {
     ...
     *
     * @return {@code true} if the current namespace is a standard structure namespace and the current role is defined
     * as standard role in it, {@code false} otherwise
     */
     ...
     *
     * @return {@code true}, if the current role in the current namespace neither belongs to the standard structure
     * roles, nor is in the domain specific namespace; otherwise {@code false}
     */
     ...
     * mapped to. After this method call {@link #getRole()} and {@link #getNamespace()} methods might change their
     * return value.
     *
     * @return {@code true} if current role and/or namespace have changed their values; otherwise {@code false} which
