...
public final class KernelExceptionMessageConstant {
    ...
    public static final String BROTLI_DICTIONARY_IS_NOT_A_STREAM = "Brotli dictionary is not a stream.";
    ...
    public static final String FAILED_TO_DECODE_BROTLI_STREAM = "Failed to decode Brotli stream.";
    ...
    public static final String INVALID_METADATA_VALUE = "Document metadata value shall be a valid XMP metadata stream.";
    ...
    public static final String METADATA_STREAM_REQUIRES_METADATA_TYPE_AND_XML_SUBTYPE =
            "Document XMP metadata stream requires /Metadata type and /XML subtype.";
