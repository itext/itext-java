...
public class JceOpenSSLPKCS8DecryptorProviderBuilderBC implements IJceOpenSSLPKCS8DecryptorProviderBuilder {
     ...
     */
    public JceOpenSSLPKCS8DecryptorProviderBuilderBC(JceOpenSSLPKCS8DecryptorProviderBuilder providerBuilder) {
     ...
     */
    @Override
    public IInputDecryptorProvider build(char[] password) throws OperatorCreationExceptionBC {
        try {
            return new InputDecryptorProviderBC(providerBuilder.build(password));
    ...
    public boolean equals(Object o) {
        ...
        JceOpenSSLPKCS8DecryptorProviderBuilderBC that = (JceOpenSSLPKCS8DecryptorProviderBuilderBC) o;
