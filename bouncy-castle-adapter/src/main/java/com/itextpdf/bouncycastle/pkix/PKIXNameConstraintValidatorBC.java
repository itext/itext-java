...
import com.itextpdf.bouncycastle.asn1.x509.GeneralSubtreeBC;
 ...
 */
public class PKIXNameConstraintValidatorBC implements IPKIXConstraintValidator {
     ...
     */
    public PKIXNameConstraintValidatorBC(PKIXNameConstraintValidator constraintValidator) {
    ...
    public void checkPermittedDN(IASN1Sequence dns) throws AbstractPKIXNameConstraintValidatorException {
        try {
            constraintValidator.checkPermittedDN(((ASN1SequenceBC) dns).getASN1Sequence());
        } catch (PKIXNameConstraintValidatorException e) {
            throw new PKIXNameConstraintValidatorExceptionBC(e);
        }
    }
    ...
    public void checkExcludedDN(IASN1Sequence dns) throws AbstractPKIXNameConstraintValidatorException {
        try {
            constraintValidator.checkExcludedDN(((ASN1SequenceBC) dns).getASN1Sequence());
        } catch (PKIXNameConstraintValidatorException e) {
            throw new PKIXNameConstraintValidatorExceptionBC(e);
        }
    }
    ...
    public void checkPermitted(IGeneralName name) throws AbstractPKIXNameConstraintValidatorException {
        try {
            constraintValidator.checkPermitted(((GeneralNameBC) name).getGeneralName());
        } catch (PKIXNameConstraintValidatorException e) {
            throw new PKIXNameConstraintValidatorExceptionBC(e);
        }
    }
    ...
    public void checkExcluded(IGeneralName name) throws AbstractPKIXNameConstraintValidatorException {
        try {
            constraintValidator.checkExcluded(((GeneralNameBC) name).getGeneralName());
        } catch (PKIXNameConstraintValidatorException e) {
            throw new PKIXNameConstraintValidatorExceptionBC(e);
        }
    }
    ...
    public void intersectPermittedSubtree(IGeneralSubtree[] permitted) {
        List<GeneralSubtree> generalSubtreeList = Arrays.stream(permitted).map(
                subtree -> ((GeneralSubtreeBC) subtree).getGeneralSubtree()).collect(Collectors.toList());
    ...
    public void addExcludedSubtree(IGeneralSubtree subtree) {
        constraintValidator.addExcludedSubtree(((GeneralSubtreeBC) subtree).getGeneralSubtree());
    }
    ...
    public boolean equals(Object o) {
        ...
        PKIXNameConstraintValidatorBC that = (PKIXNameConstraintValidatorBC) o;
