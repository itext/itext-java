...
public final class PdfUA1AnnotationChecker {
    ...
    /**
     * Is annotation visible: {@code true} if hidden flag isn't set and annotation intersects CropBox
    ...
    public static boolean isAnnotationVisible(PdfDictionary annotDict) {
        ...
        if (annotDict.getAsDictionary(PdfName.P) != null) {
            ...
            PdfArray pageBox = page.getAsArray(PdfName.CropBox) == null ?
                    page.getAsArray(PdfName.MediaBox) : page.getAsArray(PdfName.CropBox);
     ...
     */
    public static class PdfUA1AnnotationHandler extends ContextAwareTagTreeIteratorHandler {

        /**
         * Creates a new instance of the {@link PdfUA1AnnotationHandler}.
         *
         * @param context the validation context
         */
