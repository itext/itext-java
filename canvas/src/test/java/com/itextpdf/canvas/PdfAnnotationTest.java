...
public class PdfAnnotationTest extends ExtendedITextTest {
    ...
    public void addLinkAnnotation01() throws Exception {
        ...
        canvas.beginText();
        canvas.setFontAndSize(PdfFont.createStandardFont(document, FontConstants.COURIER_BOLD), 14);
    ...
    public void caretTest() throws IOException, DocumentException, InterruptedException {
        ...
        canvas
                ...
                .beginText()
                .moveText(36, 750)
                .setFontAndSize(PdfFont.createStandardFont(pdfDoc1, FontConstants.HELVETICA), 16)
    ...
    public void addFreeTextAnnotation01() throws Exception {
        ...
        new PdfCanvas(page).beginText().setFontAndSize(PdfFont.createStandardFont(document, FontConstants.COURIER), 24).moveText(100, 600).showText("Annotated text").endText().release();
    ...
    @Test
    public void printerMarkText() throws IOException, InterruptedException, DocumentException {
    ...
    @Test
    public void trapNetworkText() throws IOException, InterruptedException, DocumentException {
...
//        }
    ...
    @Test
    public void waterMarkTest() throws IOException, DocumentException, InterruptedException {
    ...
    @Test
    public void redactionTest() throws IOException, DocumentException, InterruptedException {
